...
#define JudyMalloc(size) dlmalloc((size) * sizeof(Word_t))
#define JudyMallocVirtual(size) dlmalloc((size) * sizeof(Word_t))
//#define JudyMalloc(size) dlmemalign((size) * sizeof(Word_t), 128)
//#define JudyMallocVirtual(size) dlmemalign((size) * sizeof(Word_t), 128)
#define JudyFree(ptr, size) dlfree(ptr)
#define JudyFreeVirtual(ptr, size) dlfree(ptr)
#else
